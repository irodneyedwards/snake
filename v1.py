...
def game():
   ...
   # Food  ---------------------------------------------------------- #
    ...
    poison = pygame.Rect((150, 250), CUBE)
    ...
    while running:
        ...
        if snake.x > SCREEN_SIZE_BEGINNER or snake.x < 0:
            running = False

        if snake.y > SCREEN_SIZE_BEGINNER or snake.x < 0:
            running = False
        ...
        text_objects("This your score:", WHITE)
